...
void GLWidget::myRenderVideoBackground()
{
        ...
        else if (tracker->typesBackground.DDD  == true)     qVideoFrame = tracker->sequence.videoSequence.currFrame_DDD_VIZ_QT; // QGLWidget::convertToGLFormat
        else
        {
            std::cout << "MALAKIA sto GLWidget::myRenderVideoBackground !!!" << std::endl;
        }
        ...
        {
              //qDebug() << "myRenderVideoBackground - NULL !!!" << tracker->currentFrameNumberGET();
        }
